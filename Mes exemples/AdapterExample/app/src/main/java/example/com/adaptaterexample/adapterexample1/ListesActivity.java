package example.com.adaptaterexample.adapterexample1;
...
import example.com.adaptaterexample.R;
...
public class ListesActivity extends Activity {
    ...
    */
      ...
      */
        ...
        ListAdapter adapter = new SimpleAdapter(this, liste, android.R.layout.simple_list_item_2, new String[] {"text1", "text2"},
