...
public class AndroidProvider extends ContentProvider {
	...
	public static final Uri CONTENT_URI = Uri.parse("content://example.com.contentprovider.androidprovider");
	public static final String CONTENT_PROVIDER_DB_NAME = "android.db";
	public static final int CONTENT_PROVIDER_DB_VERSION = 1;
	public static final String CONTENT_PROVIDER_TABLE_NAME = "cours";
	public static final String CONTENT_PROVIDER_MIME = "vnd.android.cursor.item/vnd.example.com.contentprovider.cours";
